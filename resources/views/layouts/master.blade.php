                    ...
                    <ul class="navbar-nav header-right">
                        ...
                        <li class="nav-item dropdown header-profile">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="https://ventic.dexignzone.com/xhtml/error-404.html" class="dropdown-item ai-icon">
    ...
    ***********************************-->
    <div class="deznav">
        <div class="deznav-scroll">
            ...
            <div class="plus-box">
                <p class="fs-16 font-w500 mb-4">Ticket Sales Weekly Report</p>
                <a class="text-white fs-14" href="javascript:void(0);">Learn more</a>
            </div>
            <div class="copyright">
                <p><strong>Ventic Ticketing Dashboard</strong> © 2021 All Rights Reserved</p>
